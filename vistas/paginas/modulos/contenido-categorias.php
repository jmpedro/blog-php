<?php
	...
	/* SELECCIÓN DE ARTICULOS POR CATEGORIA */
	if( isset($ruta[0]) ) {

		$articulos = ControladorBlog::ctrTraerDatosArticulos(0, 5, "ruta_categoria", $ruta[0]);
		$totalArticulos = ControladorBlog::ctrGetAllArticulos("id_cat", $articulos[0]["id_cat"]);
	...
	/* REVISAMOS LA PAGINACION DE CATEGORIAS */
	if( isset($ruta[1]) ) {

		if( is_numeric($ruta[1]) ){

			if( $ruta[1] > $totalPaginas ) {
				echo'<script>
						window.location = "'.$dataBlog["dominio"].'error";
					</script>';
				return;
			}
			...
			$articulos = ControladorBlog::ctrTraerDatosArticulos($desde, $cantidad, "ruta_categoria", $ruta[0]);
					...
					<div class="d-flex my-3">
						...
						<div class="w-100 w-xl-50 pr-3 pt-2">
							...
							<a href="articulos.html">
								...
								<img src="<?php echo $dataBlog["dominio"]; ?>vistas/img/articulo01.png" alt="Lorem ipsum dolor sit amet" class="img-fluid">
					...
					<div class="d-flex my-3">
						...
						<div class="w-100 w-xl-50 pr-3 pt-2">
							...
							<a href="articulos.html">
								...
								<img src="<?php echo $dataBlog["dominio"]; ?>vistas/img/articulo02.png" alt="Lorem ipsum dolor sit amet" class="img-fluid">
					...
					<div class="d-flex my-3">
						...
						<div class="w-100 w-xl-50 pr-3 pt-2">
							...
							<a href="articulos.html">
								...
								<img src="<?php echo $dataBlog["dominio"]; ?>vistas/img/articulo03.png" alt="Lorem ipsum dolor sit amet" class="img-fluid">
