		...
		<div class="row">
			...
			<div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
				...
				<div class="container">
								...
								<?php foreach( $totalArticulos as $key => $value): ?>
									...
									<li class="px-3">
										...
										<a href="<?php echo $dataBlog["dominio"].$articulo[0]["ruta_categoria"]."/".$value["p_claves_articulo"]; ?>" 
											...
											<img src="<?php echo $dataBlog["servidor"].$value["portada_articulo"]; ?>" alt="<?php echo $value["titulo_articulo"]; ?>" class="img-fluid">
							...
							<?php if( $value["aprobacion_opinion"] == 1 ): ?>
								...
								<div class="row opiniones">
									...
									<div class="col-3 col-sm-4 col-lg-2 p-2">
										...
										<img src="<?php echo $dataBlog["servidor"].$value["foto_opinion"]; ?>" class="img-thumbnail">	
									...
									<?php if( $value["respuesta_opinion"] != null ): ?>
										...
										<div class="col-3 col-sm-4 col-lg-2 p-2">
											...
											<img src="<?php echo $dataBlog["servidor"].$value["foto_admin"]; ?>" class="img-thumbnail">	
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<label for="fotoOpinion" class="d-none d-md-block col-md-4 col-lg-3">
								...
								<img src="<?php echo $dataBlog["servidor"]; ?>vistas/img/subirFoto.png" class="img-fluid mt-md-3 mt-xl-2 prevFotoOpinion">
					...
					<img src="<?php echo $dataBlog["servidor"]; ?>vistas/img/ad01.jpg" class="img-fluid my-3 d-block d-md-none" width="100%">
